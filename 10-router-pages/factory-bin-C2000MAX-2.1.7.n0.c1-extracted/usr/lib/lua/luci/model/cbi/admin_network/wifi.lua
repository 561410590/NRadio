...
if hwtype == "atheros" or hwtype == "mac80211" or hwtype == "prism2" then
	...
	local softapd = fs.access("/usr/sbin/softapd")
	local _8021xd = fs.access("/usr/sbin/8021xd")
...
-- Don't support accounting yet.
local support_acct = false
if support_acct then
...
-- Don't support 80211r yet.
local support_80211r = false
if support_80211r and (hwtype == "atheros" or hwtype == "mac80211" or hwtype == "prism2") then
