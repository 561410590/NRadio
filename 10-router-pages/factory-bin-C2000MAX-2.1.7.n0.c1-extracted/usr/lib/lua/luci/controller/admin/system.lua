...
function index()
	...
	entry({"admin", "system"}, alias("admin", "system", "system"), _("System"), 30, true).index = true
	entry({"admin", "system", "system"}, cbi("admin_system/system"), _("System"), 1)
	entry({"admin", "system", "clock_status"}, post_on({ set = true }, "action_clock_status"), nil, nil, true)
	...
	entry({"admin", "system", "reboot"}, template("admin_system/reboot"), _("Reboot"), 90,true)
	entry({"admin", "system", "reboot", "call"}, post("action_reboot"),nil,nil,true)
	entry({"admin", "syslang"}, call("action_switch_lang"),nil,nil,true)
end

function action_switch_lang()
...
function action_reboot()
	...
	nixio.syslog("err","WEB["..client_ip.."] reboot")
	luci.sys.reboot()
end
