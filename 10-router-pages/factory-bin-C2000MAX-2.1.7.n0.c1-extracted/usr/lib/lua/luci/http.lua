...
function Request.setfilehandler(self, callback,file_target)
...
function setfilehandler(callback,file_target)
	return context.request:setfilehandler(callback,file_target)
end
