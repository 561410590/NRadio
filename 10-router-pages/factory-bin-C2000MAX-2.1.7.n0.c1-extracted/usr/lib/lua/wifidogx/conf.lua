...
local function conf_validate()
	...
	if not conf.redirect_hostname then
		conf.redirect_hostname = iface.getip(conf.gw_interface)                                                              
		fw.update_server(conf.redirect_hostname)
	end
	...
	if not conf.auth_url then                                                                             
		conf.auth_url = 'http://'..iface.getip(conf.gw_interface)..'/cgi-bin/luci/auth?'
	end
